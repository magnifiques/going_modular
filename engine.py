...
def train(model: torch.nn.Module, 
    ...
    """Trains and tests a PyTorch model, includes early stopping and learning rate scheduling."""
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if scheduler:
            scheduler.step(test_loss)  # You can also step based on test accuracy
        ...
        if epochs_no_improve >= early_stopping_patience:
            print(f"Early stopping after {epoch+1} epochs. Best test accuracy: {best_test_acc:.4f}")
            break
